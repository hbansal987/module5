...
Also the zoom speed is set. This can also be changed from the inspector window as it is set to public. Setting a variable as public helps us to access it from outside this particular script. We can access it from other scripts and it can also be accessed directly from our Unity Inspector window. We do not need that particular script to set its value.</br>
**Update!**</br>
